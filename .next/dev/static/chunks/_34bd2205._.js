...
function LoginPage() {
    ...
    const { isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "LoginPage.useAppSelector": (state)=>state.auth
    }["LoginPage.useAppSelector"]);
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
            email,
            password
        }));
        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"].fulfilled.match(result)) {
            localStorage.setItem("auth-state", JSON.stringify(result.payload));
...
_s(LoginPage, "64Wg8NxILo74dvrpVN21TdCC0ho=", false, function() {
    return [

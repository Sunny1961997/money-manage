...
const loginUser = createAsyncThunk("auth/loginUser", async ({ email, password }, { rejectWithValue })=>{
    try {
        const { user, token } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(email, password);
        return {
            user,
            token
        };
...
const logoutUser = createAsyncThunk("auth/logoutUser", async (token, { rejectWithValue })=>{
    try {
        if (token) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logout"])(token);
        }
        return null;
    } catch (error) {
        ...
        "ReduxInitializer.useEffect": ()=>{
            ...
            if (storedAuth) {
                try {
                    ...
                    if (user && token) {
                        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$slices$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restoreAuthFromStorage"])({
                            user,
                            token
                        }));
                    }
...
_s(ReduxInitializer, "DKdeqxp2QYw2p6z8/ErYMRK/Ubo=", false, function() {
    return [
...
//# sourceMappingURL=_7646cbb5._.js.map
...
async function GET(req) {
    ...
    console.log("[API] /admin/dashboard GET called");
    if (!decodedToken) {
    ...
    try {
        const res = await fetch(`${("TURBOPACK compile-time value", "http://127.0.0.1:8000")}/api/admin/dashboard`, {
            method: "GET",
            headers: {
        ...
        console.log("[API] admin dashboard response:", data);
        if (!res.ok) {
        ...
        console.error("[API] admin dashboard fetch error:", err);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            message: err.message || "Failed to fetch admin dashboard"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31f4e5ad._.js.map
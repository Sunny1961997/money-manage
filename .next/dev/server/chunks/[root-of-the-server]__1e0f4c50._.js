...
"[project]/app/api/sanction-entities/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, ctx) {
    ...
    const res = await fetch(`${("TURBOPACK compile-time value", "http://127.0.0.1:8000")}/api/sanction-entities/${encodeURIComponent(id)}`, {
        method: "GET",
        headers,
        cache: "no-store"
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e0f4c50._.js.map
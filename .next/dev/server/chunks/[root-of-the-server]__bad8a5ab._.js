...
"[project]/app/api/onboarding/customers/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        ...
        const res = await fetch(`${("TURBOPACK compile-time value", "http://127.0.0.1:8000")}/api/onboarding/customers/${id}`, {
            method: "GET",
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bad8a5ab._.js.map
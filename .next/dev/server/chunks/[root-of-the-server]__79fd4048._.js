...
"[project]/app/api/goaml/reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const apiUrl = `${("TURBOPACK compile-time value", "http://127.0.0.1:8000")}/api/goaml-reports${query}`;
...
async function POST(req) {
    ...
    const apiUrl = `${("TURBOPACK compile-time value", "http://127.0.0.1:8000")}/api/goaml-reports`;
    const res = await fetch(apiUrl, {
        method: "POST",
        headers,
        credentials: "include",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79fd4048._.js.map
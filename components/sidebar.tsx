...
import { useState, Dispatch, SetStateAction, useEffect, Fragment } from "react"
...
const adminNavigation: NavItem[] = [
  ...
  { name: "Revenue Dashboard", href: "/dashboard/admin/revenue-dashboard", icon: LayoutDashboard },
]
...
export function Sidebar({ isCollapsed, setIsCollapsed }: SidebarProps) {
  ...
  return (
    <Fragment>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-screen z-50 border-r border-border bg-sidebar flex flex-col transition-all duration-300",
          isCollapsed ? (isMobile ? "-translate-x-full" : "w-16") : "w-72"
        )}
